...
const columns = [
  ...
  ['queued', 'Queue', 'Starts automatically when a slot frees.'],
...
export default function Requests() {
  ...
  // Arriving from a project pre-applies its filter, so the board opens scoped.
